# terraform-oci-arch-ee-exa-db-mig
...
Now, you'll want a local copy of this repo. You can make that with the commands:
    ...
    git clone https://github.com/oracle-devrel/terraform-oci-arch-db-migration.git
    cd terraform-oci-arch-db-migration/oci-arch-ee-exa-db-mig
    ls
...
# DB admin password for starter database
starter_db_admin_password = "<starter_db_admin_password>"

# exacs_x8_infra
exacs_x8_infra = false <= if you want to deploy old X7 platform
